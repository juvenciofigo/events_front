...
export default function Footer() {
    return (
        <footer className="border-t border-border bg-surface pt-12 pb-6">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex gap-2">
                            <a
                                ...
                                className="w-8 h-8 bg-surface/5 hover:bg-surface/10 border border-border rounded-md flex items-center justify-center text-muted hover:text-text transition-all"
                            >
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-text mb-4">Plataforma</h4>
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-text mb-4">Empresa</h4>
                        <ul className="space-y-2.5 text-xs text-muted">
                            <li>
