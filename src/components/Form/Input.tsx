        ...
        return (
            <div className={`${className}`}>
                ...
                <div className="relative">
                    ...
                    <input
                        ref={ref}
                        className={`w-full mb-1 py-1 bg-surface border border-borderColor rounded text-xs md:text-sm  text-text placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all ${InputClassName}`}
                        {...rest}
                    />
