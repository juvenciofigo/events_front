                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredEvents.map((event) => (
                            <Link
                                ...
                                key={event.id}
                                className="group relative bg-surface border border-white/5 rounded-sm overflow-hidden hover:border-primary/30 transition-all hover:-translate-y-2 duration-300"
                            >
                                {/* Image */}
